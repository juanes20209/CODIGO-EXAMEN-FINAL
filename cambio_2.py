...
class ChessGame(tk.Tk):
    ...
    def on_click(self, row, col):
        if not self.selected_piece:
            ...
            self.move_piece(row, col)  # Llamada al método move_piece
    ...
    def move_piece(self, row, col):
        ...
        self.selected_piece = None
        self.refresh_board()  # Llamada al método refresh_board

    def refresh_board(self):
        # Agregar lógica para actualizar la interfaz gráfica con el nuevo estado del tablero
        pass  # Por ahora, no se implementa la actualización gráfica
